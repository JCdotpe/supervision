...
<form:form modelAttribute="reporteForm" cssClass="form-horizontal upperx" acceptCharset="UTF-8">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <form:checkbox path="matriz" id="idCheckIMatriz" cssClass="form-control checkbox-inline" value="false"/>
            </div>
            <div id="idComponeteVisible">
            	<label for="componenteId" class="col-sm-1 control-label">Componente - SubComponente</label>
	            <div class="col-sm-2">
