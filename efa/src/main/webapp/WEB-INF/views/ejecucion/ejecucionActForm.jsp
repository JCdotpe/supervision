...
<div class="form-group">
        ...
        <div class="col-sm-3">
        	<form:input name = "fechaejec" path="fechaejec" class="form-control datepicker" />
        	<div class="help-block error"></div>
        </div>       
        <div class="col-sm-2">
        <label for="inputType" class="control-label">Amerita Supervision Especial</label>
        	<form:checkbox name="supespecial" value="true" path="supespecial" id="supespecial" class="form-control" />
        	<div class="help-block error"></div>
        </div> 
        <div class="col-sm-2">
        <label for="inputType" class="control-label">Presenta Hallázgos Críticos</label>
        	<form:checkbox name="hallazgos" value="true" path="hallazgos" id="hallazgos" class="form-control" />
        	<div class="help-block error"></div>
         </div> 	
</div>  
<div class="form-group">
        ...
        <div class="col-sm-3">
        	<form:input name = "fecha" path="fecha" class="form-control datepicker" />
        	<div class="help-block error"></div>
        </div>    
        ...
        <div class="col-sm-3">
        	<form:input path="observacion" id="observacion" class="form-control"/>
        	<div class="help-block error"></div>
        </div>          
</div>
